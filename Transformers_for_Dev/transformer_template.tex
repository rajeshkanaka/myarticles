...
\usepackage{amssymb}         % For additional symbols, including ∞
...
\newcommand{\makekanakacover}{
    \begin{titlepage}
        ...
        \vspace{0.3cm}
        {\Large\color{white}Explained Simply\par}
        \vspace{0.5cm}
        {\large\color{white}A Developer's Guide\par}
        \vspace{1cm}
...
\newcommand{\makecustomtitlepage}{
    \begin{titlepage}
        ...
        \vspace{1cm}
        {\Large\color{covercolor}Explained Simply: A Developer's Guide\par}
        \vspace{2cm}
