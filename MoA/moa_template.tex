...
\pagestyle{fancy}
\fancyhead[L]{Collaborative Intelligence}
\fancyhead[R]{\thepage}
\fancyfoot[C]{How Mixture of Agents is Shaping the Future of Intelligent Systems}
...
\newcommand{\makekanakacover}{
    \begin{titlepage}
        ...
        \vspace{0.5cm}
        {\Huge\bfseries\color{white}Collaborative Intelligence\par}
        \vspace{0.3cm}
        {\Large\color{white}How Mixture of Agents is Shaping the Future of Intelligent Systems\par}
        \vspace{0.5cm}
        {\large\color{white}MoA vs MoE\par}
        \vspace{1cm}
...
\newcommand{\makecustomtitlepage}{
    \begin{titlepage}
        \centering
        \vspace*{2cm}
        {\Huge\bfseries\color{covercolor}Collaborative Intelligence\par}
        \vspace{1cm}
        {\Large\color{covercolor}How Mixture of Agents is Shaping the Future of Intelligent Systems\par}
        \vspace{2cm}
